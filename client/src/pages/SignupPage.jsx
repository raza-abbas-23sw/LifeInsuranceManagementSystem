    ...
    return (
        <div className="font-sans min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#007ACC10] to-[#007ACC01]">
            ...
            <motion.div
                ...
                className="relative z-10 min-md:bg-white/20 backdrop-blur-sm md:my-7 rounded-2xl shadow-sm border border-gray-100 p-8 w-full max-w-md"
            >
                <motion.div
                    variants={container}
                    initial="hidden"
                ...
                >
                    ...
                    <motion.div variants={item} className="text-center mb-8">
                        ...
                        <p className="text-gray-600" style={{ color: customBlue }}>
                            Create your secure insurance account
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <motion.div variants={item} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                >
                                    <FiUser className="text-gray-400" style={{ color: customBlue }} />
                                    <input
                                        type="text"
                                        placeholder="name"
