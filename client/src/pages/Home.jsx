      ...
      <div className="relative">
        ...
        >
          <motion.div
            ...
            style={{
              background: "linear-gradient(90deg, #007ACC10, #007ACC30, #007ACC10)",
...
<section id="features" className="relative py-24 overflow-hidden">
  ...
  <div className="container mx-auto px-6 relative z-10">
    ...
    >
      ...
      >
        <div className="relative">
          ...
          <div className="relative px-6 py-2 rounded-full border border-[#007ACC20] bg-white/80 backdrop-blur-sm">
            <span className="text-sm font-medium" style={{ color: "#007ACC" }}>
              OUR ADVANTAGES
            </span>
          </div>
        </div>
      ...
      >
        Why <span style={{ color: "#007ACC" }}>State Life</span> Stands Out
      </motion.h2>
      ...
      >
        Innovative protection that evolves with your family through every life stage,
        backed by 50+ years of trusted service.
      </motion.p>
    </motion.div>
    ...
    >
      ...
      {/* See Plans Section */}
<section id="plans" className="relative py-24 overflow-hidden bg-gray-50/90">
  {/* Particle background */}
  <div className="absolute inset-0 z-0 overflow-hidden">
    {[...Array(30)].map((_, i) => (
      <motion.div
    ...
    >
      ...
      >
        <div className="relative">
          ...
          >
            <div className="w-3 h-3 rounded-full mr-2" style={{ backgroundColor: "#007ACC" }} />
            <span className="font-medium" style={{ color: "#007ACC" }}>50+ Plans Available</span>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        ...
        >
          Tailored <span style={{ color: "#007ACC" }}>Protection</span> Plans
        </motion.h2>
